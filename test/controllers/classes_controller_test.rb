...
class ClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class" do
    assert_difference('Classe.count') do
      post classes_url, params: { class: { date_start: @class.date_start, day: @class.day, description: @class.description, instructor_name: @class.instructor_name, name: @class.name } }
    end
  ...
  test "should update class" do
    patch class_url(@class), params: { class: { date_start: @class.date_start, day: @class.day, description: @class.description, instructor_name: @class.instructor_name, name: @class.name } }
